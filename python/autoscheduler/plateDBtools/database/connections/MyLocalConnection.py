...
if os.environ.has_key("PLATEDB_LOCAL_USER"):
    db_config['user'] = os.environ["PLATEDB_LOCAL_USER"]
if os.environ.has_key("PLATEDB_LOCAL_PASSWORD"):
    db_config['password'] = os.environ["PLATEDB_LOCAL_PASSWORD"]
if os.environ.has_key("PLATEDB_LOCAL_HOST"):
    db_config['host'] = os.environ["PLATEDB_LOCAL_HOST"]
