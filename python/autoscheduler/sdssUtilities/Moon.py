...
import math
from math import degrees, radians, pi, fabs, cos, sin, asin, acos, sqrt, log
import datetime
...
class Moon(object):
	...
	def _set_position(self):
		...
		jdJan0 = convert.datetime2jd(datetime.datetime(self.datetimeObj.year,1,1,hour=0, minute=0, second=0))
